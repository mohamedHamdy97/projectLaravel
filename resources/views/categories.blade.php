        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav">
              ...
              <li class="nav-item px-2">
                <a href="categories.blade.php" class="nav-link active">Categories</a>
              </li>
              <li class="nav-item px-2">
              ...
              @if(count($dat1)>0)
                  @foreach($dat1 as $item)
                    <tr>
                      ...
                      <td>
                    <a href="/cat/{{$item->id}}" class="btn btn-danger">
                      <i class="fas fa-trash"></i> Remove
                    </a>
                  </td>
                  <td><a href="/details_cat.blade.php/{{$item->id}}" class="btn btn-secondary">
                      <i class="fas "></i> Edits
                    </a>
                      </td>
                </tr>
