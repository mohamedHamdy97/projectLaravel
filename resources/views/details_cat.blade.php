    ...
    <section id="actions" class="py-4 mb-4 bg-light">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              <a href="index.blade.php" class="btn btn-danger btn-block mb-2">
      ...
      <div class="row">
        <div class="col">
          <div class="card">
            ...
            <div class="card-body">
            <form action="/details_cat/{{$catid->id}}" method= "post"  >
                @csrf
                @method('put')
                <div class="form-group">
                  <label for="title">Name</label>
                  <input type="text" name="name" value="{{$catid->name}}" class="form-control">
                </div>
