...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark p-0">
        <div class="container">
          <a href="index.blade.php" class="navbar-brand">Blogen</a>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav">
              ...
              <li class="nav-item px-2">
                <a href="posts.blade.php" class="nav-link active">Product</a>
              </li>
              <li class="nav-item px-2">
                ...
                <table class="table table-striped">
                  ...
                  @foreach($dat as $item)
                    <tr>
                      ...
                      <td><img src="../images/{{$item->image}}" width="30px" height=30px; alt=""></td>
                      <td>
                        <a href="details.blade.php/{{$item->id}}" class="btn btn-secondary">
